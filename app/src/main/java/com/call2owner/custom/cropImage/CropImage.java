...
//  
  ...
  public static final class ActivityBuilder {
    ...
    public Intent start(@NonNull Activity activity) {
      mOptions.validate();
      return getIntent(activity);
    }

    
    public Intent start(@NonNull Activity activity, @Nullable Class<?> cls) {
      mOptions.validate();
      return getIntent(activity, cls) ;
    }

    
    public Intent start(@NonNull Context context, @NonNull Fragment fragment) {
      return getIntent(context);
    }

    public Intent start(@NonNull Context context, @NonNull Fragment fragment, @Nullable Class<?> cls) {
