...
public class CropImageView extends FrameLayout {
  ...
  public void saveCroppedImageAsync(Uri saveUri) {
    saveCroppedImageAsync(saveUri, Bitmap.CompressFormat.JPEG, 40, 0, 0, RequestSizeOptions.NONE);
  }
  ...
  public Parcelable onSaveInstanceState() {
    ...
    if (mSaveBitmapToInstanceState && imageUri == null && mImageResource < 1) {
      mSaveInstanceStateBitmapUri =
           imageUri = BitmapUtils.writeTempStateStoreBitmap(getContext(), mBitmap, mSaveInstanceStateBitmapUri);
    }
