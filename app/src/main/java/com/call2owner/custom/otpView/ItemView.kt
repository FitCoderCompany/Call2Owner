...
class ItemView : FrameLayout {
    ...
    private fun generateViews(styles: TypedArray) {
        ...
        val barMargin = styles.getDimension(R.styleable.OtpTextView_bar_margin, Utils.getPixels(
            context,
            0
        ).toFloat())
        ...
        hideOTPDrawable = styles.getResourceId(R.styleable.OtpTextView_hide_otp_drawable, R.drawable.dot)
